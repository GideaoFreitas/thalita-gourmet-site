...
with col_principal:
  ...
  if st.button(
    ...
    if not nome_cliente or not telefone_cliente or not endereco:
    ...
    elif bairro_selecao == "Outros" and not bairro_outro:
      ...
      # Tratamento das taxas (Se for Outros, taxa promocional de R$ 5,00)
      if bairro_selecao == "Outros":
        taxa_entrega = 5.0
      else:
        taxa_entrega = 0.0  # Demais bairros da lista possuem frete grátis

...
# --- CSS PERSONALIZADO (Desktop: Foto à Direita | Mobile: Foto no Topo) ---
st.markdown(
    """
    <style>
    ...
    /* Caixas de input e texto */
    input, textarea {
        color: #222222 !important;
        background-color: #ffffff !important;
    }
    
    /* Cor do texto nos menus de seleção */
    div[data-baseweb="select"] * {
        color: #222222 !important;
    }
    
    /* Fundo das caixas de entrada */
    ...
    @media (max-width: 768px) {
        ...
        /* No celular: move a coluna da foto (2ª coluna) para o TOPO da tela */
        div.element-container:has(div.main-layout-marker) + div[data-testid="stHorizontalBlock"] {
            display: flex !important;
            flex-direction: column-reverse !important;
        }

        /* Ajusta o tamanho da foto no celular */
        div.element-container:has(div.main-layout-marker) + div[data-testid="stHorizontalBlock"] > div[data-testid="stColumn"]:nth-child(2) img {
...
# Marcador para aplicar o CSS no layout principal
st.markdown('<div class="main-layout-marker"></div>', unsafe_allow_html=True)

# Layout em Duas Colunas (No Desktop: Esquerda = Conteúdo, Direita = Foto da Dona)
...
with col_principal:
    ...
    cardapio = {
        "Pratinho de festa": {
            "preco": 15,  # Você pode alterar o preço aqui se desejar
